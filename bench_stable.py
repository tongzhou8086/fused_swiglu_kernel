...
VARIANTS = [
    ...
    ("CUDA B-nostg overlap NS=7 GSM=16",
     lambda: fs.cuda_matmul_save_factors_b_nostg(x, W_packed, (256, 64, 7, 16))),
    ("CUDA B-nostg overlap NS=7 GSM=8",
     lambda: fs.cuda_matmul_save_factors_b_nostg(x, W_packed, (256, 64, 7, 8))),
    ("CUDA B-nostg overlap NS=4 GSM=16",
     lambda: fs.cuda_matmul_save_factors_b_nostg(x, W_packed, (256, 64, 4, 16))),
    ("CUDA B+TMAst overlap NS=4 GSM=16",
     lambda: fs.cuda_matmul_save_factors_b_tmast(x, W_packed, (256, 64, 4, 16))),
    ("CUDA B+TMAst overlap NS=4 GSM=8",
     lambda: fs.cuda_matmul_save_factors_b_tmast(x, W_packed, (256, 64, 4, 8))),
    ("CUDA B+TMAst overlap NS=4 GSM=32",
     lambda: fs.cuda_matmul_save_factors_b_tmast(x, W_packed, (256, 64, 4, 32))),
]
